...
import CourseCardAdmin from "../../../components/layout/CourseCard/CourseCardAdmin";
...
const UserCourses = ({user, isAuthenticated}) => {
        // Get the router
                ...
                <div className={"container"}>
                    <div className={classes.ContentContainer}>
                        <section className={classes.ContentFilter}>
                            {isAuthenticated && user && <button onClick={() => router.push('/admin/create_course')}
                                                                className={classes.Create_Button}>Create Course <Image
