...
const blog = ({isAuthenticated, user}) => {
    // Get the router
    ...
    return (
        <>
            <Head>
                <title>GooAdmin Blog</title>
                <meta name="description" content="Stay up-to-date on the latest news and trends in software development and education with our blog."/>
                <meta name="keywords" content="blog, gooadmin, software development, education services"/>
            </Head>
                ...
                <div className={classes.ContentContainer}>
                    ...
                    <section className={classes.ContentCards}>
                        ...
                        <div className={classes.Cards_Container}>
                            {blogPosts.result ? (
                                blogPosts.result.map(
                                    (
                                        {mainImage, category, header, _id},
                                        index
                                    ) => {
                                        return (
                                            <Link
